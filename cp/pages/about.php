...
$breadcrumbs = [__('nav_pages') => null, __('about_title') => null];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
       ...
       db()->query(
    "INSERT INTO tbl_pages (page_key, title, content, meta_title, meta_description) VALUES (?,?,?,?,?)
    ...
    $meta_desc
        ...
        logActivity('update', 'pages', __('about_title') . ' ' . __('msg_page_saved'));
...
<div class="page-header">
    <div class="page-header-left">
        <h1><i class="fas fa-info-circle"></i> <?= __('about_title') ?></h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" value="<?= htmlspecialchars($pg['title'] ?? __('about_title')) ?>" required>
                </div>
            </div>
        </div>
