...
$breadcrumbs = [__('nav_pages') => null, __('terms_title') => null];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $meta_desc
        ...
        logActivity('update', 'pages', __('terms_title') . ' ' . __('msg_page_saved'));
...
<div class="page-header">
    <div class="page-header-left">
        <h1><i class="fas fa-scroll"></i> <?= __('terms_title') ?></h1>
        <p><?= __('terms_title') ?></p>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" value="<?= htmlspecialchars($pg['title'] ?? __('terms_title')) ?>" required>
                </div>
            </div>
        </div>
